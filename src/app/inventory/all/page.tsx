...
export default function AllInventory() {
  ...
  return (
    <div style={{ padding: '60px 20px', maxWidth: '1200px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '42px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '8px' }}>All Inventory</h1>
      <p style={{ color: '#999', fontSize: '16px', marginBottom: '30px' }}>Browse our complete selection of new and pre-owned boats</p>
            ...
            <div key={item.id} style={{ background: '#0B1325', border: '1px solid #1a2040', borderRadius: '8px', overflow: 'hidden', transition: 'transform 0.3s, border-color 0.3s' }}
              ...
              <div style={{ padding: '20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                  ...
                  <span style={{ fontSize: '11px', fontWeight: 600, textTransform: 'uppercase', padding: '3px 8px', borderRadius: '3px', background: item.condition === 'new' ? '#EB2E25' : '#333', color: '#fff', whiteSpace: 'nowrap', marginLeft: '8px' }}>
